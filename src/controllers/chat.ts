...
const genAI = new GoogleGenAI({
    apiKey:
        process.env.GEMINI_API_KEY || "AIzaSyBR22l5pwtdITdlAwNwvLUnV1JA6ZwMMSI"
});
    ...
    try {
        ...
        const event: InngestEvent = {
            ...
            data: {
                ...
                goals: [],
                systemPrompt:
                    "You are a calm, empathetic therapeutic assistant. Respond with warmth, clarity, and professionalism.",
            },
        };
        ...
        try {
        // Extract first JSON object Gemini returns
        ...
        logger.error("Failed to parse Gemini analysis JSON", {
            analysisText,
            error: err,
        });
        }
        ...
        const rawResponseText =
            typeof responseResult.text === "string"
                ? responseResult.text
                : "";

            const response_ = rawResponseText
            .replace(/```json/gi, "")
            .replace(/```/g, "")
            .trim() ||
